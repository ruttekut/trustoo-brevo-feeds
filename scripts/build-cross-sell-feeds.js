...
const TARGETS = {
  ...
  hypotheekadviseur: { name: 'Hypotheekadviseurs', label: 'Financieel', text: 'Laat berekenen wat je kunt lenen en vergelijk hypotheken met onafhankelijk advies, ook bij oversluiten.' },
  ...
  verhuisbedrijf: { name: 'Verhuisbedrijven', label: 'Verhuizen', text: 'Laat inpakken, vervoeren en sjouwen uit handen nemen, zodat de verhuisdag rustig en zonder gedoe verloopt.' },
  ...
  weddingplanner: { name: 'Weddingplanners', label: 'Feest & event', text: 'Een weddingplanner bewaakt planning, leveranciers en budget, zodat jij ontspannen van de dag kunt genieten.' },
  ...
  aannemer: { name: 'Aannemers', label: 'Verbouwen', text: 'Voor grotere klussen waarbij meerdere vakmensen samenkomen. Een aannemer plant, regelt en coördineert.' },
