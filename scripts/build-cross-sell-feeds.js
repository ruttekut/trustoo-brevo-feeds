...
const THEMES = {
  ...
  wonen: {
    heading: ['Je woning', 'kopen of verkopen', 'goed geregeld'],
    intro: 'Bij een koop of verkoop komen meerdere adviseurs langs. Deze diensten vroegen anderen via Trustoo vaak aan rond hetzelfde moment. Vergelijk beoordelingen en vraag gratis offertes aan.',
  },
  tuin: {
  ...
  welzijn: {
    heading: ['Werken aan', 'jezelf', ''],
    intro: 'Lekker in je vel zitten heeft veel kanten: hoofd, lijf en werk. Deze professionals vinden anderen vaak in dezelfde periode. Vergelijk beoordelingen en vraag gratis offertes aan.',
  },
  juridisch: {
    heading: ['Je zaak', 'goed geregeld', ''],
    intro: 'Juridische en financiële zaken lopen vaak in elkaar over. Deze specialisten schakelen anderen vaak samen in. Vergelijk beoordelingen en vraag gratis offertes aan.',
  },
  onderhoud: {
  ...
  afscheid: {
    ...
    intro: 'Rond een afscheid moet er veel geregeld worden, vaak in korte tijd. Deze diensten kunnen daarbij helpen. Vergelijk beoordelingen en vraag vrijblijvend offertes aan.',
  },
  kantoor: {
...
// ---------------------------------------------------------------------------
const SOURCES = {
  notaris: { noun: 'een notaris', theme: 'wonen', title: ['Alles rond je', 'woning', 'in één keer geregeld'], bridge: 'Een bezoek aan de notaris is vaak één stap in een groter geheel: een koop, verkoop of nieuwe fase. Makelaar, hypotheek en verhuizing horen er dan vaak bij.', subject: 'Notaris geregeld? Dit hoort er vaak nog bij', preheader: 'Van makelaar tot verhuizer: dit regelen mensen vaak rond hun bezoek aan de notaris.' },
  ...
  uitvaartverzorger: { noun: 'een uitvaartverzorger', theme: 'afscheid', title: ['Steun bij alles wat er', 'geregeld', 'moet worden'], bridge: 'Rond een afscheid komt er in korte tijd veel op je af. Voor de dag zelf en voor wat daarna geregeld moet worden, kun je hulp inschakelen.', subject: 'Hulp bij wat er rond een afscheid geregeld moet worden', preheader: 'Catering, notaris, schoonmaak en verhuizing: diensten die kunnen helpen in deze periode.' },
  ...
  mediator: { noun: 'een mediator', theme: 'juridisch', title: ['Samen tot een', 'oplossing', 'komen'], bridge: 'Mediation is vaak het begin. Juridisch advies, financieel overzicht of een gesprek met een psycholoog kunnen daarbij helpen.', subject: 'Mediator gevonden? Dit kan er nog bij helpen', preheader: 'Advocaat, psycholoog, financieel adviseur of notaris: hulp die anderen vaak naast mediation inschakelen.' },
  ...
  advocaat: { noun: 'een advocaat', theme: 'juridisch', title: ['Je zaak van alle kanten', 'goed', 'geregeld'], bridge: 'Naast een advocaat schakelen mensen vaak hulp in om afspraken vast te leggen of samen tot een oplossing te komen.', subject: 'Advocaat gevonden? Dit schakelen anderen erbij in', preheader: 'Mediator, scheidingsmediator, notaris of belastingadviseur: vaak samen met een advocaat aangevraagd.' },
  ...
  incassobureau: { noun: 'een incassobureau', theme: 'financien', title: ['Je', 'openstaande zaken', 'afgerond'], bridge: 'Een incasso is vaak het sluitstuk. Juridisch advies, een goede administratie of bemiddeling voorkomen herhaling.', subject: 'Incasso uitbesteed? Dit regelen ondernemers erbij', preheader: 'Advocaat, accountant, boekhouder en mediator: vaak samen met een incassobureau aangevraagd.' },
  ...
  coaching: { noun: 'een coach', theme: 'welzijn', title: ['Werken aan', 'jezelf', 'op meer vlakken'], bridge: 'Coaching is één manier om te groeien. Hoofd, lijf en werk versterken elkaar.', subject: 'Coach gevonden? Dit combineren anderen ermee', preheader: 'Psycholoog, personal trainer, diëtist of loopbaancoach: hulp die anderen naast coaching kiezen.' },
  ...
  relatietherapeut: { noun: 'een relatietherapeut', theme: 'welzijn', title: ['Werken aan wat', 'belangrijk', 'is'], bridge: 'Relatietherapie staat zelden op zichzelf. Ook individuele hulp of praktisch advies kan steun geven.', subject: 'Relatietherapeut gevonden? Dit kan ook helpen', preheader: 'Scheidingsmediator, psycholoog, coach of financieel adviseur: hulp die anderen ernaast kiezen.' },
  ...
  vertaler: { noun: 'een vertaler', theme: 'juridisch', title: ['Je documenten', 'compleet', 'geregeld'], bridge: 'Vertalingen zijn vaak nodig voor officiële zaken. Een tolk, notaris of advocaat komt daar vaak bij.', subject: 'Vertaler gevonden? Dit hoort er vaak bij', preheader: 'Tekstschrijver, tolk, notaris en advocaat: vaak samen met een vertaling aangevraagd.' },
  psycholoog: { noun: 'een psycholoog', theme: 'welzijn', title: ['Goed voor', 'jezelf', 'zorgen'], bridge: 'Een gesprek met een psycholoog is een belangrijke stap. Andere vormen van begeleiding kunnen daarop aansluiten.', subject: 'Psycholoog gevonden? Dit kan ook steun geven', preheader: 'Relatietherapeut, coach, mediator of diëtist: begeleiding die anderen ernaast kiezen.' },
  ...
  hypotheekadviseur: { noun: 'een hypotheekadviseur', theme: 'wonen', title: ['Je', 'woning', 'kopen, goed geregeld'], bridge: 'Hypotheekadvies is één stap in het koopproces. Aankoop, taxatie en notaris horen er meestal bij.', subject: 'Hypotheekadviseur gevonden? Dit komt er vaak bij', preheader: 'Aankoopmakelaar, taxateur, notaris en financieel adviseur: vaak samen met hypotheekadvies aangevraagd.' },
  ...
  taxateur: { noun: 'een taxateur', theme: 'wonen', title: ['Je', 'woning', 'kopen, goed geregeld'], bridge: 'Een taxatie is meestal onderdeel van een koop of hypotheek. De andere stappen volgen vaak snel.', subject: 'Taxateur gevonden? Dit komt er vaak bij', preheader: 'Hypotheekadviseur, aankoopmakelaar, notaris en bouwkundige keuring: vaak samen aangevraagd.' },
  ...
  loopbaancoach: { noun: 'een loopbaancoach', theme: 'welzijn', title: ['Een nieuwe stap in je', 'werk', 'en leven'], bridge: 'Een loopbaanvraag raakt vaak aan meer: hoe je je voelt, je energie en je gewoontes.', subject: 'Loopbaancoach gevonden? Dit kan ook helpen', preheader: 'Psycholoog, coach, personal trainer of diëtist: begeleiding die anderen ernaast kiezen.' },
  'mediator-scheiding': { noun: 'een scheidingsmediator', theme: 'juridisch', title: ['Je scheiding', 'goed', 'geregeld'], bridge: 'Bij een scheiding komen juridische, financiële en persoonlijke vragen samen. Ook de woning vraagt aandacht.', subject: 'Scheidingsmediator gevonden? Dit hoort er vaak bij', preheader: 'Advocaat, financieel adviseur, psycholoog en hypotheekadviseur: hulp die anderen ernaast inschakelen.' },
  ...
  'bouwkundige-keuring': { noun: 'een bouwkundige keuring', theme: 'wonen', title: ['Weten wat je', 'koopt', 'en dan doorpakken'], bridge: 'Een keuring hoort meestal bij een koop. Aankoopmakelaar, taxatie en hypotheek lopen daar vaak gelijk mee op.', subject: 'Bouwkundige keuring geregeld? Dit komt er vaak bij', preheader: 'Aankoopmakelaar, taxateur, hypotheekadviseur en energielabel: vaak samen met een keuring aangevraagd.' },
  ...
  tolk: { noun: 'een tolk', theme: 'juridisch', title: ['Elkaar', 'begrijpen', 'in elke situatie'], bridge: 'Een tolk is vaak nodig bij officiële afspraken. Vertaling, juridisch advies en vastlegging horen erbij.', subject: 'Tolk gevonden? Dit hoort er vaak bij', preheader: 'Vertaler, advocaat, notaris en mediator: vaak samen met een tolk aangevraagd.' },
  ...
  'personal-trainer': { noun: 'een personal trainer', theme: 'welzijn', title: ['Fit worden,', 'lekker', 'in je vel'], bridge: 'Trainen werkt het best samen met goede voeding en aandacht voor hoe je je voelt.', subject: 'Personal trainer gevonden? Dit combineren anderen ermee', preheader: 'Diëtist, coach, psycholoog of loopbaancoach: begeleiding die anderen naast trainen kiezen.' },
  dietist: { noun: 'een diëtist', theme: 'welzijn', title: ['Gezond leven,', 'stap', 'voor stap'], bridge: 'Voeding is één kant. Beweging en mentale balans maken het plaatje compleet.', subject: 'Diëtist gevonden? Dit combineren anderen ermee', preheader: 'Personal trainer, coach, psycholoog of loopbaancoach: begeleiding die anderen ernaast kiezen.' },
...
// ---------------------------------------------------------------------------
const TARGETS = {
  makelaar: { name: 'Makelaars', label: 'Wonen', text: 'Koop of verkoop je een woning? Een makelaar kent de lokale markt en regelt bezichtigingen en onderhandeling.' },
  hypotheekadviseur: { name: 'Hypotheekadviseurs', label: 'Financieel', text: 'Laat berekenen wat je kunt lenen en vergelijk hypotheken met onafhankelijk advies.' },
  advocaat: { name: 'Advocaten', label: 'Juridisch', text: 'Vraag juridisch advies of bijstand die past bij jouw situatie, van contract tot conflict.' },
  ...
  videograaf: { name: 'Videografen', label: 'Feest & event', text: 'Leg de sfeer van je dag vast in beeld en geluid, van de eerste toost tot de laatste dans.' },
  fotograaf: { name: 'Fotografen', label: 'Feest & event', text: 'Een fotograaf legt de mooiste momenten vast, zodat je er later nog vaak van geniet.' },
  catering: { name: 'Cateraars', label: 'Feest & event', text: 'Van hapjes tot buffet: een cateraar regelt eten en drinken, zodat jij aandacht hebt voor je gasten.' },
  weddingplanner: { name: 'Weddingplanners', label: 'Feest & event', text: 'Een weddingplanner bewaakt planning, leveranciers en budget, zodat jij ontspannen kunt genieten.' },
  notaris: { name: 'Notarissen', label: 'Juridisch', text: 'Voor de akte, een testament of samenlevingscontract: een notaris legt afspraken officieel vast.' },
  accountant: { name: 'Accountants', label: 'Financieel', text: 'Laat je jaarrekening opstellen en controleren en krijg advies over je bedrijfsvoering.' },
  belastingadviseur: { name: 'Belastingadviseurs', label: 'Financieel', text: 'Haal het maximale uit je aangifte en voorkom verrassingen met advies op maat.' },
  'financieel-adviseur': { name: 'Financieel adviseurs', label: 'Financieel', text: 'Krijg overzicht over inkomen, vermogen en toekomstplannen met onafhankelijk advies.' },
  'online-marketing': { name: 'Online marketing bureaus', label: 'Marketing', text: 'Word gevonden door nieuwe klanten via zoekmachines, social media en advertenties.' },
  psycholoog: { name: 'Psychologen', label: 'Welzijn', text: 'Praat met een professional als je vastloopt of meer grip wilt op hoe je je voelt.' },
  ...
  mediator: { name: 'Mediators', label: 'Juridisch', text: 'Los een conflict samen op met een onafhankelijke bemiddelaar, zonder meteen naar de rechter te stappen.' },
  'mediator-scheiding': { name: 'Scheidingsmediators', label: 'Juridisch', text: 'Regel de afspraken rond je scheiding in goed overleg, met begeleiding van een specialist.' },
  dj: { name: "DJ's", label: 'Feest & event', text: 'Een DJ leest de zaal en houdt de dansvloer vol, met muziek die past bij jouw feest.', link: "Bekijk DJ's" },
  stukadoor: { name: 'Stukadoors', label: 'Afwerking', text: 'Strakke muren en plafonds zijn de basis voor verf of behang. Laat het stucwerk vooraf doen.' },
  ...
  vloerlegger: { name: 'Vloerleggers', label: 'Afwerking', text: 'Een nieuwe vloer maakt het af. Laat hem strak leggen door een vakman, van laminaat tot pvc.' },
  loodgieter: { name: 'Loodgieters', label: 'Installatie', text: 'Voor leidingen, afvoer en sanitair. Handig bij een verbouwing of als iets lekt of verstopt zit.' },
  elektricien: { name: 'Elektriciens', label: 'Installatie', text: 'Extra groepen, stopcontacten of verlichting: laat het veilig aanleggen en keuren.' },
  ...
  aannemer: { name: 'Aannemers', label: 'Verbouwen', text: 'Voor grotere klussen waarbij meerdere vakmensen samenkomen. Een aannemer regelt en coördineert.' },
  dakkapellen: { name: 'Dakkapelspecialisten', label: 'Buitenkant', text: 'Meer ruimte en licht op zolder? Een dakkapel wordt vaak in één dag geplaatst.' },
  dakgoot: { name: 'Dakgootspecialisten', label: 'Buitenkant', text: 'Laat je dakgoten reinigen, repareren of vervangen en voorkom lekkage en vochtproblemen.' },
  gevelrenovatie: { name: 'Gevelrenovatiebedrijven', label: 'Buitenkant', text: 'Voegwerk herstellen, scheuren repareren of impregneren: houd je gevel sterk en droog.' },
  'seo-specialist': { name: 'SEO-specialisten', label: 'Marketing', text: 'Sta hoger in Google met een website die technisch en inhoudelijk goed in elkaar zit.', link: 'Bekijk SEO-specialisten' },
  'grafisch-ontwerper': { name: 'Grafisch ontwerpers', label: 'Marketing', text: 'Een herkenbaar logo en huisstijl maken je bedrijf professioneel, online en op papier.' },
  tekstschrijver: { name: 'Tekstschrijvers', label: 'Marketing', text: 'Sterke teksten voor je website, brochure of nieuwsbrief, die je verhaal helder vertellen.' },
  alarmsystemen: { name: 'Alarmsysteemspecialisten', label: 'Veiligheid', text: 'Een alarmsysteem of camera geeft rust, thuis en op de zaak. Laat het vakkundig installeren.' },
  tegelzetter: { name: 'Tegelzetters', label: 'Afwerking', text: 'Voor wand en vloer in badkamer, keuken of toilet. Strak tegelwerk maakt de ruimte af.' },
  isolatie: { name: 'Isolatiebedrijven', label: 'Energie', text: 'Isoleer dak, muren of vloer en bespaar direct op je energierekening. Vaak met subsidie.' },
  'bouwkundige-keuring': { name: 'Bouwkundig keurders', label: 'Wonen', text: 'Weet wat je koopt of waar je aan toe bent: een keuring brengt gebreken en kosten in beeld.' },
  ongediertebestrijder: { name: 'Ongediertebestrijders', label: 'Schoon & onderhoud', text: 'Muizen, wespen of andere ongewenste gasten? Laat het vakkundig en veilig aanpakken.' },
  klusjesman: { name: 'Klusjesmannen', label: 'Klussen', text: 'Voor de kleine klussen die blijven liggen: ophangen, monteren, repareren en afwerken.' },
  verzekering: { name: 'Verzekeringsadviseurs', label: 'Financieel', text: 'Controleer of je goed verzekerd bent, van inboedel en opstal tot aansprakelijkheid.' },
  stratenmaker: { name: 'Stratenmakers', label: 'Tuin', text: 'Een nieuw terras, pad of oprit? Een stratenmaker legt sierbestrating strak en waterpas.' },
  boomverzorging: { name: 'Boomverzorgers', label: 'Tuin', text: 'Snoeien, kappen of controleren: een boomverzorger houdt je bomen gezond en veilig.' },
  hekwerk: { name: 'Hekwerkspecialisten', label: 'Tuin', text: 'Een schutting of hek geeft privacy en maakt je tuin af. Laat het stevig plaatsen.' },
  webdesign: { name: 'Webdesigners', label: 'Marketing', text: 'Een website die er goed uitziet en werkt op elk scherm. Het visitekaartje van je bedrijf.' },
  metselaar: { name: 'Metselaars', label: 'Verbouwen', text: 'Voor een aanbouw, tuinmuur of herstel van metselwerk. Vakwerk dat jaren meegaat.' },
  stoffeerder: { name: 'Stoffeerders', label: 'Interieur', text: 'Trapbekleding, vloerbedekking of meubels opnieuw bekleden. Maatwerk dat je interieur afmaakt.' },
  opslag: { name: 'Opslagruimtes', label: 'Verhuizen', text: 'Tijdelijk spullen kwijt tijdens een verhuizing of verbouwing? Huur een veilige opslagruimte.' },
  'personal-trainer': { name: 'Personal trainers', label: 'Welzijn', text: 'Werk gericht aan je conditie en kracht, met een schema en begeleiding die bij jou passen.' },
  dietist: { name: 'Diëtisten', label: 'Welzijn', text: 'Eet beter met advies dat past bij jouw lijf en leven, zonder ingewikkelde regels.' },
  keukenrenovatie: { name: 'Keukenspecialisten', label: 'Verbouwen', text: 'Nieuwe keuken of je huidige keuken opknappen? Van ontwerp tot montage geregeld.' },
  'badkamer-renovatie': { name: 'Badkamerspecialisten', label: 'Verbouwen', text: 'Een nieuwe badkamer van ontwerp tot oplevering, inclusief leidingwerk en tegels.' },
  'cv-verwarmings-installateur': { name: 'Cv-installateurs', label: 'Installatie', text: 'Ketel vervangen, onderhoud of radiatoren erbij: houd je verwarming betrouwbaar en zuinig.', link: 'Bekijk cv-installateurs' },
  'warmtepomp-installateur': { name: 'Warmtepompinstallateurs', label: 'Energie', text: 'Verwarm je huis zonder gas. Laat berekenen welke warmtepomp bij je woning past.' },
  ...
  zonwering: { name: 'Zonweringspecialisten', label: 'Comfort', text: 'Houd de warmte buiten met screens, een markies of rolluiken. Op maat gemaakt en gemonteerd.' },
  rioolservice: { name: 'Rioolspecialisten', label: 'Schoon & onderhoud', text: 'Verstopping, stank of lekkage? Een rioolspecialist inspecteert en lost het op.' },
  interieurstylist: { name: 'Interieurstylisten', label: 'Interieur', text: 'Krijg een plan voor kleuren, materialen en indeling dat alles in je huis samenbrengt.' },
  'energielabel-adviseur': { name: 'Energielabeladviseurs', label: 'Energie', text: 'Verplicht bij verkoop en verhuur, en een handig startpunt om te verduurzamen.' },
  relatietherapeut: { name: 'Relatietherapeuten', label: 'Welzijn', text: 'Werk samen aan je relatie met een therapeut die het gesprek weer op gang brengt.' },
  coaching: { name: 'Coaches', label: 'Welzijn', text: 'Een coach helpt je doelen scherp te krijgen en stappen te zetten, privé of in je werk.' },
  zonnepanelen: { name: 'Zonnepaneleninstallateurs', label: 'Energie', text: 'Wek je eigen stroom op en verlaag je energierekening. Vraag offertes aan voor jouw dak.' },
  tolk: { name: 'Tolken', label: 'Juridisch', text: 'Een tolk zorgt dat iedereen elkaar begrijpt bij een afspraak, zitting of belangrijk gesprek.' },
  reclamebureau: { name: 'Reclamebureaus', label: 'Marketing', text: 'Een campagne of concept dat opvalt, van idee tot uitvoering.' },
  glaszetter: { name: 'Glaszetters', label: 'Buitenkant', text: 'Ruit gebroken of over op isolatieglas? Een glaszetter plaatst het snel en vakkundig.' },
  boekhouder: { name: 'Boekhouders', label: 'Financieel', text: 'Houd je administratie op orde en laat je aangiftes op tijd en correct doen.' },
  timmerman: { name: 'Timmermannen', label: 'Verbouwen', text: 'Voor maatwerk in hout: kasten, kozijnen, vloeren en constructiewerk.' },
  dakdekker: { name: 'Dakdekkers', label: 'Buitenkant', text: 'Lekkage, onderhoud of een nieuw dak? Laat het dak inspecteren voordat het gaat lekken.' },
  trouwfotograaf: { name: 'Trouwfotografen', label: 'Feest & event', text: 'Een trouwfotograaf legt jullie dag vast, van de voorbereidingen tot het feest.' },
  aankoopmakelaar: { name: 'Aankoopmakelaars', label: 'Wonen', text: 'Een aankoopmakelaar zoekt mee, beoordeelt de woning en onderhandelt voor jou.' },
  beveiliging: { name: 'Beveiligingsbedrijven', label: 'Veiligheid', text: 'Van alarmopvolging tot toezicht op je pand: beveiliging die past bij je situatie.' },
  thuisbatterij: { name: 'Thuisbatterij-installateurs', label: 'Energie', text: 'Sla je eigen zonnestroom op en gebruik hem wanneer je hem nodig hebt.' },
  laadpalen: { name: 'Laadpaalinstallateurs', label: 'Energie', text: 'Laad je elektrische auto thuis. Laat een laadpaal plaatsen die past bij je aansluiting.' },
  meubelmaker: { name: 'Meubelmakers', label: 'Interieur', text: 'Een kast, tafel of inbouwmeubel op maat, precies passend in jouw ruimte.' },
  asbest: { name: 'Asbestverwijderaars', label: 'Verbouwen', text: 'Woning van voor 1994? Laat asbest veilig inventariseren en verwijderen voor je gaat slopen.' },
  sloopbedrijf: { name: 'Sloopbedrijven', label: 'Verbouwen', text: 'Muur eruit of oude keuken weg? Een sloopbedrijf werkt veilig en voert het afval af.' },
  schoorsteenveger: { name: 'Schoorsteenvegers', label: 'Buitenkant', text: 'Laat je schoorsteen jaarlijks vegen voor een veilige haard en een goede trek.' },
  vochtbestrijding: { name: 'Vochtbestrijders', label: 'Schoon & onderhoud', text: 'Vochtplekken, schimmel of een natte kelder? Laat de oorzaak opsporen en oplossen.' },
  vertaler: { name: 'Vertalers', label: 'Juridisch', text: 'Officiële documenten of teksten laten vertalen, ook beëdigd als dat nodig is.' },
  hovenier: { name: 'Hoveniers', label: 'Tuin', text: 'Van ontwerp tot aanleg en onderhoud: een hovenier maakt van je tuin een plek om te zijn.' },
  gevelreiniging: { name: 'Gevelreinigers', label: 'Buitenkant', text: 'Laat je gevel reinigen en impregneren tegen vuil, groene aanslag en vocht.' },
  loopbaancoach: { name: 'Loopbaancoaches', label: 'Welzijn', text: 'Twijfel over je werk? Een loopbaancoach helpt je ontdekken wat bij je past.' },
};
...
const SKIP_NOTE = 'Niets nodig op dit moment? Dan kun je deze mail gewoon negeren. We sturen je alleen wat past bij je aanvraag.';
const CLOSING = {
...
function linkLabel(t) {
  ...
  return 'Bekijk ' + t.name.charAt(0).toLowerCase() + t.name.slice(1);
}
...
function buildFeed(slug, cards, images) {
  ...
  cards.forEach((target, i) => {
    ...
    feed[`card${n}_link_label`] = linkLabel(t);
  });
  feed.skip_note = SKIP_NOTE;
